            ...
            <div class="col-md-12" >
                ...
                <div class="tile">
                    <div class="row invoice">
                        ...
                        <h4><?php echo $st[0]['ST_Name']; ?> <span style="float: right;margin-right: 20px;">WO.NO: <?php echo $wo[0]['WO_Number']; ?></span></h4>
...
<!--                            </div>-->
                            <div class="col-md-3">
                                <input class="form-control" type="hidden" name="PI_Icode"  id="PI_Icode" value="<?php echo $invoice[0]['Proforma_Icode']; ?>" >
                                <h5><span>WO Date</span><input type="hidden" name="invoice_date" id="invoice_date" value="<?php echo $invoice[0]['Proforma_Date']; ?>" readonly><?php echo $invoice[0]['Proforma_Date']; ?></h5>
