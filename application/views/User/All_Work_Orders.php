                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        foreach ($wo as $val)
                        {
                            ...
                            <tr>
                                ...
                                <?php
                                if ($val['PI_Type'] == '1') { ?>
                                    <td> <a class="btn btn-info" href="<?php echo site_url('User_Controller/Sheet_WO/') . $val['Proforma_Icode']. '/1'  ; ?>">Print Sheet WO</a></td>
                                    <?php
                                }
                                else
                                {
                                    ?>
                                    <td><a class="btn btn-info" href="<?php echo site_url('User_Controller/Normal_WO/') . $val['Proforma_Icode'].'/0'; ?>">Print Normal WO</a></td>
                                    <?php
                                }
                                ?>
                            </tr>
