...
<main class="app-content">
    <div>
        <div class="app-title">
            <div>
                <h1><i class="fa fa-edit"></i>Report Invoice</h1>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="tile">
                <div class="tile-body">
                    <form method="post" class="login-form" action="<?php echo site_url('User_Controller/Print_Bill_Report'); ?>" name="data_register" onsubmit="return confirm('Do you really want to Print ?');">
                    <div class="row">
                    <div class="col-md-4">
                        <h4>From</h4>
