        ...
        <div class="row">
            ...
            <div class="col-md-12" >
                ...
                <div class="tile" id="page_setup">
                  ...
                  <?php if ($val['print_id'] == '10') { 

                      if($invoice[0]['PI_Type'] == '2')
                      {  ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div id="consign">
                                ...
                                <h6 class="heading"><span>Work Order Time</span> :<?php $date = $wo[0]['WO_Created_On']; echo date("H:i",strtotime($date)); ?></h6>
                            </div>
                        </div>
                        <div class="col-md-6">
