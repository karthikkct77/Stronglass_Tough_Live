                ...
                <form method="post" class="login-form" action="<?php echo site_url('User_Controller/PDF_Bill'); ?>" name="data_register" >
                    ...
                    <div class="row" id="with_print">
                        ...
                        <div class="col-md-6">
                            ...
                            <button class="btn btn-primary pi_button " type="submit" id="with_print"><i class="fa fa-fw fa-lg fa-check-circle"></i>PDF</button>
                            <a class="btn btn-info" href="<?php echo site_url('User_Controller/Print_Bill/') . $invoice[0]['Proforma_Icode']; ?>">print</a>
                            <a class="btn btn-success pi_button" id="with_print" href="<?php echo site_url('User_Controller/Edit_Bill/').$invoice[0]['Proforma_Icode']; ?>">EDIT Bill</a>
<!--                            <a class="btn btn-danger pi_button" id="with_print" href="--><?php //echo site_url('User_Controller/Cancel_Bill/').$bill[0]['Bill_Icode']; ?><!--">Cancel</a>-->
