<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-edit"></i>Double Glazing Profoma Invoice</h1>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6" id="add">
            <div class="tile">
                ...
                <div class="tile-body">
                    <form method="post" enctype="multipart/form-data" class="login-form" action="<?php echo site_url('User_Controller/Upload_DG_Invoice'); ?>" name="data_register">
