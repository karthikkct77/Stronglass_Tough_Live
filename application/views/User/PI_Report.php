    ...
    <div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="tile">
                    <div class="tile-body">
                        <form method="post" class="login-form" action="<?php echo site_url('User_Controller/Print_PI_Report'); ?>" name="data_register" onsubmit="return confirm('Do you really want to Print ?');">
                            <div class="row">
                                <div class="col-md-4">
                                    <h4>From</h4>
