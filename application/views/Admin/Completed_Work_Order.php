<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-edit"></i>Completed  Work Order List</h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item"><a href="#">Completed Work Order</a></li>
        </ul>
    </div>
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="tile">
                <h3 class="tile-title">Work Order</h3>
                <div class="tile-body">
                    <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        foreach ($work_order as $val)
                        {
                            ...
                            <tr>
                                ...
                                <td><?php echo $val['WO_Completed_On']; ?></td>
