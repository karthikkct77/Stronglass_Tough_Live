...
<!--                   <li><a class="treeview-item" href="--><?php //echo site_url('Admin_Controller/Today_Despatch_Report'); ?><!--"><i class="icon fa fa-circle-o"></i>Despatch Report</a></li>-->
           ...
           <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-eye"></i><span class="app-menu__label">Export Invoice</span><i class="treeview-indicator fa fa-angle-right"></i></a>
               <ul class="treeview-menu">
