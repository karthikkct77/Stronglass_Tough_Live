<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-edit"></i>Export Profoma Invoice</h1>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-6" id="add">
            <div class="tile">
                ...
                <?php } ?>
                <h3 class="tile-title">Upload Export PI Data (From Excel)</h3>
                <div class="tile-body">
                    <form method="post" enctype="multipart/form-data" class="login-form" action="<?php echo site_url('Admin_Controller/Upload_Export_Invoice'); ?>" name="data_register">
